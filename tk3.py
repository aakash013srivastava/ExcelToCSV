...
tkinter.messagebox.showinfo("Information","Convert excel to csv using this utility")

answer = tkinter.messagebox.askquestion("Conversion utility usage","Do you want to convert excel to csv?")
